...
//     denominator: 1
// };
// let num1 = fraction1.numerator = +prompt('Enter numerator for 1st fraction'); //запрашиваем числитель
// let den1 = fraction1.denominator = +prompt('Enter denominator for 1st fraction'); //запрашиваем знаменатель
